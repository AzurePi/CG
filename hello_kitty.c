/*
 *  Adaptado de um código De Ana Beatriz da Silva Zeratti
 */
...
void drawHelloKitty() {
    ...
    // Nariz
    glColor3f(1.0f, 0.9f, 0.4f); // Amarelo
    ...
    // Orelha esquerda
    glVertex2f(-0.47f, 0.2f); // topo
    glVertex2f(-0.4f, 0.7f); // esquerda
    glVertex2f(-0.2f, 0.4f); // direita
